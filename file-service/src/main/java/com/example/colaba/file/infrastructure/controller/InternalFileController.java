package com.example.colaba.file.infrastructure.controller;
...
public class InternalFileController {
    ...
    private final FileServiceFacade fileService;
    ...
    public ResponseEntity<List<FileResponse>> upload(
        ...
        UploadFileRequest request = UploadFileRequest.builder()
                ...
                .files(files)
                .build();
        List<FileResponse> result = fileService.uploadFiles(request);
    ...
    public ResponseEntity<List<FileResponse>> getByTaskId(
            @RequestParam("taskId") @NotNull Long taskId) {
        List<FileResponse> attachments = fileService.getAttachments(taskId);
